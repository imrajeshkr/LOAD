-- =============================================================================
-- LOAD — expose demo_path through today_plan()
--
-- Migration 0016 added exercises.demo_path but today_plan()'s JSON was never
-- updated to return it, so the Guide screen had no way to know which asset to
-- load. Same pattern as 0015: re-declare the whole function since Postgres
-- can't ALTER a single field out of a plpgsql body.
-- =============================================================================
