...
-- LOAD — v2 schema
--
-- ⚠️  DESTRUCTIVE. This drops the v1 tables and recreates the domain from
--     scratch. It is written for the current state of the project: one real
--     user plus dummy seed data, where a clean cutover is cheaper than a
--     staged migration. Do not run this against a database whose training
--     history you care about without taking a backup first.
--
-- Design notes live in supabase/design/v2_schema_proposal.sql.
-- =============================================================================
...
drop table if exists public.protein_logs   cascade;
drop table if exists public.weight_logs    cascade;
drop table if exists public.session_sets   cascade;
drop table if exists public.sessions       cascade;
drop table if exists public.profiles       cascade;

-- ── drop v2 (so this migration is re-runnable while iterating) ──────────
drop view if exists public.v_flagged_exercises     cascade;
drop view if exists public.v_adherence             cascade;
drop view if exists public.v_nutrition_daily       cascade;
drop view if exists public.v_weekly_muscle_volume  cascade;
drop view if exists public.v_exercise_daily_bests  cascade;
drop view if exists public.v_session_totals        cascade;

drop table if exists public.coach_proposals        cascade;
drop table if exists public.coach_messages         cascade;
drop table if exists public.coach_threads          cascade;
drop table if exists public.coach_memories         cascade;
...
drop table if exists public.exercise_cues          cascade;
drop table if exists public.exercise_equipment     cascade;
drop table if exists public.exercise_joints        cascade;
drop table if exists public.exercise_muscles       cascade;
drop table if exists public.exercises              cascade;
drop table if exists public.environment_equipment  cascade;
drop table if exists public.equipment              cascade;
drop table if exists public.joints                 cascade;
drop table if exists public.muscles                cascade;
drop table if exists public.training_profiles      cascade;
drop table if exists public.user_preferences       cascade;
drop table if exists public.profiles               cascade;

drop function if exists public.est_1rm(numeric, int)   cascade;
drop function if exists public.set_updated_at()        cascade;
drop function if exists public.stamp_performed_on()    cascade;
drop function if exists public.resolve_exercise(uuid, text) cascade;
drop function if exists public.bootstrap_user(uuid)    cascade;

drop type if exists public.unit_system       cascade;
drop type if exists public.training_goal     cascade;
drop type if exists public.experience_level  cascade;
drop type if exists public.train_environment cascade;
drop type if exists public.split_type        cascade;
drop type if exists public.load_type         cascade;
drop type if exists public.muscle_role       cascade;
drop type if exists public.program_status    cascade;
drop type if exists public.block_intent      cascade;
...
drop type if exists public.alt_reason        cascade;
drop type if exists public.coach_role        cascade;
drop type if exists public.proposal_kind     cascade;
drop type if exists public.proposal_status   cascade;
drop type if exists public.severity_level    cascade;
drop type if exists public.authored_by       cascade;
